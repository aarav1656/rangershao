  ...
  return _createClass(ApiClient, [{
    ...
    */
    ...
    value: function setHeader(header) {
      this.defaultHeaders = _objectSpread(_objectSpread({}, this.defaultHeaders), header);
    }
    ...
    */
    ...
    value: function callApi(path, httpMethod, pathParams, queryParams, headerParams, formParams, bodyParam, authNames, contentTypes, accepts, returnType, apiBasePath) {
      ...
      queryParams = Object.keys(queryParams).filter(function (k) {
        return queryParams[k] !== undefined && queryParams[k] !== '';
      }).reduce(function (acc, key) {
        acc[key] = queryParams[key];
        return acc;
      }, {});
      var queryStr = Object.keys(queryParams).filter(function (k) {
        return queryParams[k] !== undefined && queryParams[k] !== '';
      }).map(function (k) {
