 ...
 */
var UpdateDestinationBankAccount = /*#__PURE__*/function () {
  /**
   ...
   */
  function UpdateDestinationBankAccount(account_alias, account_number, swift_code, currency, beneficiary_name, beneficiary_address, bank_name, bank_address) {
    _classCallCheck(this, UpdateDestinationBankAccount);
   ...
   */
  return _createClass(UpdateDestinationBankAccount, null, [{
    key: "initialize",
    value: function initialize(obj, account_alias, account_number, swift_code, currency, beneficiary_name, beneficiary_address, bank_name, bank_address) {
    ...
    value: function validateJSON(data) {
      ...
      var _iterator = _createForOfIteratorHelper(UpdateDestinationBankAccount.RequiredProperties),
        _step;
      try {
