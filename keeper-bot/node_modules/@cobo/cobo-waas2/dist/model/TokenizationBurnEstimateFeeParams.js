 ...
 */
var TokenizationBurnEstimateFeeParams = /*#__PURE__*/function () {
  /**
   ...
   */
  function TokenizationBurnEstimateFeeParams(source, burns, operation_type, token_id) {
    _classCallCheck(this, TokenizationBurnEstimateFeeParams);
   ...
   */
  return _createClass(TokenizationBurnEstimateFeeParams, null, [{
    key: "initialize",
    value: function initialize(obj, source, burns, operation_type, token_id) {
      obj['source'] = source;
      obj['burns'] = burns;
    ...
    value: function validateJSON(data) {
      ...
      var _iterator = _createForOfIteratorHelper(TokenizationBurnEstimateFeeParams.RequiredProperties),
        _step;
      try {
...
var _default = exports["default"] = TokenizationBurnEstimateFeeParams;