...
var _EstimatedEvmEip1559FeeSlow = _interopRequireDefault(require("./EstimatedEvmEip1559FeeSlow"));
...
var EstimatedEvmEip1559Fee = /*#__PURE__*/function () {
  ...
  function EstimatedEvmEip1559Fee(fee_type, token_id, recommended) {
    _classCallCheck(this, EstimatedEvmEip1559Fee);
   ...
   */
  return _createClass(EstimatedEvmEip1559Fee, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('slow')) {
          obj['slow'] = _EstimatedEvmEip1559FeeSlow["default"].constructFromObject(data['slow']);
        }
        if (data.hasOwnProperty('recommended')) {
          obj['recommended'] = _EstimatedEvmEip1559FeeSlow["default"].constructFromObject(data['recommended']);
        }
        if (data.hasOwnProperty('fast')) {
          obj['fast'] = _EstimatedEvmEip1559FeeSlow["default"].constructFromObject(data['fast']);
        }
      }
      return obj;
    }
    ...
    value: function validateJSON(data) {
      ...
      var _iterator = _createForOfIteratorHelper(EstimatedEvmEip1559Fee.RequiredProperties),
        _step;
      try {
...
var _default = exports["default"] = EstimatedEvmEip1559Fee;