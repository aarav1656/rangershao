 ...
 */
var CustodialWalletInfo = /*#__PURE__*/function () {
  /**
   ...
   */
  function CustodialWalletInfo(wallet_id, wallet_type, wallet_subtype, name, org_id) {
    _classCallCheck(this, CustodialWalletInfo);
   ...
   */
  return _createClass(CustodialWalletInfo, null, [{
    key: "initialize",
    value: function initialize(obj, wallet_id, wallet_type, wallet_subtype, name, org_id) {
    ...
    value: function validateJSON(data) {
      ...
      var _iterator = _createForOfIteratorHelper(CustodialWalletInfo.RequiredProperties),
        _step;
      try {
