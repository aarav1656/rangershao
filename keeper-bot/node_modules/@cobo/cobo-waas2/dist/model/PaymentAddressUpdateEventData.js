 ...
 */
var PaymentAddressUpdateEventData = /*#__PURE__*/function () {
  /**
   ...
   */
  return _createClass(PaymentAddressUpdateEventData, null, [{
    key: "initialize",
    value: function initialize(obj, data_type, custom_payer_id, payer_id, chain, previous_address, updated_address) {
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('previous_address')) {
          obj['previous_address'] = _ApiClient["default"].convertToType(data['previous_address'], 'String');
        }
        if (data.hasOwnProperty('updated_address')) {
          obj['updated_address'] = _ApiClient["default"].convertToType(data['updated_address'], 'String');
        }
      }
      return obj;
    }
    ...
    value: function validateJSON(data) {
      ...
      var _iterator = _createForOfIteratorHelper(PaymentAddressUpdateEventData.RequiredProperties),
        _step;
      try {
...
var _default = exports["default"] = PaymentAddressUpdateEventData;