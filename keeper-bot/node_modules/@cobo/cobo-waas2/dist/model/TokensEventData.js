 ...
 */
var TokensEventData = /*#__PURE__*/function () {
  /**
  ...
  function TokensEventData(data_type, tokens) {
    _classCallCheck(this, TokensEventData);
   ...
   */
  return _createClass(TokensEventData, null, [{
    key: "initialize",
    value: function initialize(obj, data_type, tokens) {
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('tokens')) {
          obj['tokens'] = _ApiClient["default"].convertToType(data['tokens'], [_TokenInfo["default"]]);
        }
    ...
    value: function validateJSON(data) {
      ...
      var _iterator = _createForOfIteratorHelper(TokensEventData.RequiredProperties),
        _step;
      try {
      ...
      if (data['tokens']) {
        ...
        var _iterator2 = _createForOfIteratorHelper(data['tokens']),
          _step2;
        try {
          for (_iterator2.s(); !(_step2 = _iterator2.n()).done;) {
            var item = _step2.value;
            _TokenInfo["default"].validateJSON(item);
          }
        } catch (err) {
          _iterator2.e(err);
        } finally {
...
var _default = exports["default"] = TokensEventData;