...
var Refund = /*#__PURE__*/function () {
   ...
   */
  function Refund(refund_id, token_id, chain_id, amount, to_address, status) {
   ...
   */
  return _createClass(Refund, null, [{
    key: "initialize",
    value: function initialize(obj, refund_id, token_id, chain_id, amount, to_address, status) {
    ...
    value: function validateJSON(data) {
      ...
      var _iterator = _createForOfIteratorHelper(Refund.RequiredProperties),
        _step;
      try {
