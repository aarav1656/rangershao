...
var _TokenizationUpdateAllowlistAddressesParams = _interopRequireDefault(require("./TokenizationUpdateAllowlistAddressesParams"));
 ...
 */
var TokenizationUpdateAllowlistAddressesEstimateFeeParams = /*#__PURE__*/function () {
  /**
   ...
   */
  function TokenizationUpdateAllowlistAddressesEstimateFeeParams(action, source, addresses, operation_type, token_id) {
    _classCallCheck(this, TokenizationUpdateAllowlistAddressesEstimateFeeParams);
    _TokenizationUpdateAllowlistAddressesParams["default"].initialize(this, action, source, addresses);
   ...
   */
  return _createClass(TokenizationUpdateAllowlistAddressesEstimateFeeParams, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        _TokenizationUpdateAllowlistAddressesParams["default"].constructFromObject(data, obj);
    ...
    value: function validateJSON(data) {
      ...
      var _iterator = _createForOfIteratorHelper(TokenizationUpdateAllowlistAddressesEstimateFeeParams.RequiredProperties),
        _step;
      try {
 ...
 * @member {module:model/TokenizationUpdateAddressAction} action
 */
_TokenizationUpdateAllowlistAddressesParams["default"].prototype['action'] = undefined;
/**
 * @member {module:model/TokenizationTokenOperationSource} source
 */
_TokenizationUpdateAllowlistAddressesParams["default"].prototype['source'] = undefined;
/**
 * A list of addresses to manage. For 'add' operations, notes can be provided. For 'remove' operations, notes are ignored.
 * @member {Array.<module:model/TokenizationUpdateAllowlistAddressesParamsAddressesInner>} addresses
 */
_TokenizationUpdateAllowlistAddressesParams["default"].prototype['addresses'] = undefined;
var _default = exports["default"] = TokenizationUpdateAllowlistAddressesEstimateFeeParams;