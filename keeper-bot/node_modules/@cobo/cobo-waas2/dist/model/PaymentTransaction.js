  ...
  return _createClass(PaymentTransaction, null, [{
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('counterparty')) {
          obj['counterparty'] = _Counterparty["default"].constructFromObject(data['counterparty']);
        }
    ...
    value: function validateJSON(data) {
      ...
      if (data['counterparty']) {
        // data not null
        if (!!_Counterparty["default"].validateJSON) {
          _Counterparty["default"].validateJSON(data['counterparty']);
        }
      }
      // validate the optional field `destination`
      if (data['destination']) {
        // data not null
        if (!!_Destination["default"].validateJSON) {
          _Destination["default"].validateJSON(data['destination']);
        }
      }
      return true;
    }
