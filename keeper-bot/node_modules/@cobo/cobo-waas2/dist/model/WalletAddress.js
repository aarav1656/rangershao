...
var _AddressRiskLevel = _interopRequireDefault(require("./AddressRiskLevel"));
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('risk_level')) {
          obj['risk_level'] = _AddressRiskLevel["default"].constructFromObject(data['risk_level']);
        }
        if (data.hasOwnProperty('screening_timestamp')) {
          obj['screening_timestamp'] = _ApiClient["default"].convertToType(data['screening_timestamp'], 'Number');
        }
