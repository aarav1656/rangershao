 ...
 */
var CreateMpcWalletParams = /*#__PURE__*/function () {
  /**
   ...
   */
  return _createClass(CreateMpcWalletParams, null, [{
    key: "initialize",
    value: function initialize(obj, name, wallet_type, wallet_subtype, vault_id) {
      obj['name'] = name;
    ...
    value: function validateJSON(data) {
      ...
      var _iterator = _createForOfIteratorHelper(CreateMpcWalletParams.RequiredProperties),
        _step;
      try {
