...
var _MaxFeeAmount = _interopRequireDefault(require("./MaxFeeAmount"));
...
var TransactionFixedFee = /*#__PURE__*/function () {
   ...
   */
  function TransactionFixedFee(fee_type) {
    _classCallCheck(this, TransactionFixedFee);
    _MaxFeeAmount["default"].initialize(this);
   ...
   */
  return _createClass(TransactionFixedFee, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        _MaxFeeAmount["default"].constructFromObject(data, obj);
    ...
    value: function validateJSON(data) {
      ...
      var _iterator = _createForOfIteratorHelper(TransactionFixedFee.RequiredProperties),
        _step;
      try {
...
var _default = exports["default"] = TransactionFixedFee;