 ...
 */
var CreateCustodialWalletParams = /*#__PURE__*/function () {
  /**
   ...
   */
  function CreateCustodialWalletParams(name, wallet_type, wallet_subtype) {
    _classCallCheck(this, CreateCustodialWalletParams);
   ...
   */
  return _createClass(CreateCustodialWalletParams, null, [{
    key: "initialize",
    value: function initialize(obj, name, wallet_type, wallet_subtype) {
      obj['name'] = name;
    ...
    value: function validateJSON(data) {
      ...
      var _iterator = _createForOfIteratorHelper(CreateCustodialWalletParams.RequiredProperties),
        _step;
      try {
